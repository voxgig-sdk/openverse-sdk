...
local SDK_MODULE = "openverse_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["audio"] = { ["test01"] = { id = "test01" } }, ["image"] = { ["test01"] = { id = "test01" } }, ["o_auth2_application"] = { ["test01"] = { id = "test01" } }, ["o_auth2_key_info"] = { ["test01"] = { id = "test01" } }, ["o_auth2_token"] = { ["test01"] = { id = "test01" } } } }'
