...
describe("OAuth2KeyInfoDirect", function()
  it("should direct-load-o_auth2_key_info", function()
    local setup = o_auth2_key_info_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-o_auth2_key_info", setup.live and "live" or "unit")
...
function o_auth2_key_info_direct_setup(mockres)
