...
local OpenverseSDK = {}
OpenverseSDK.__index = OpenverseSDK
...
OpenverseSDK._make_feature = _make_feature


function OpenverseSDK.new(options)
  local self = setmetatable({}, OpenverseSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function OpenverseSDK:options_map()
...
function OpenverseSDK:get_utility()
  return Utility.copy(self._utility)
end


function OpenverseSDK:get_root_ctx()
  return self._rootctx
end


function OpenverseSDK:prepare(fetchargs)
...
function OpenverseSDK:direct(fetchargs)
...
-- by passing it.
function OpenverseSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function OpenverseSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "OpenverseSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function OpenverseSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = OpenverseSDK.new(sdkopts)
  sdk.mode = "test"
