...
from openverse_sdk.utility import register

# Load features
from openverse_sdk.feature.base_feature import OpenverseBaseFeature
from openverse_sdk.features import _has_feature, _make_feature
...
class OpenverseSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = OpenverseUtility()
        self._utility = utility

        from openverse_sdk.config import shared_config
    ...
    def get_utility(self):
        return OpenverseUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenverseSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def OAuth2Application(self, data=None) -> "OAuth2ApplicationEntity":
        ...
        from openverse_sdk.entity.o_auth2_application_entity import OAuth2ApplicationEntity
    ...
    def OAuth2KeyInfo(self, data=None) -> "OAuth2KeyInfoEntity":
        ...
        from openverse_sdk.entity.o_auth2_key_info_entity import OAuth2KeyInfoEntity
    ...
    def OAuth2Token(self, data=None) -> "OAuth2TokenEntity":
        ...
        from openverse_sdk.entity.o_auth2_token_entity import OAuth2TokenEntity
