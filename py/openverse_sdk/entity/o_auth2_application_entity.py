...
class OAuth2ApplicationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OAuth2ApplicationEntity(self._client, opts)
    ...
    def data_get(self) -> OAuth2Application:
    ...
    def match_get(self) -> OAuth2Application:
    ...
    def create(self, reqdata: OAuth2ApplicationCreateData, ctrl=None) -> OAuth2Application:
        utility = self._utility
