...
class OAuth2TokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OAuth2TokenEntity(self._client, opts)
    ...
    def match_get(self) -> OAuth2Token:
    ...
    def create(self, reqdata: OAuth2TokenCreateData, ctrl=None) -> OAuth2Token:
        utility = self._utility
