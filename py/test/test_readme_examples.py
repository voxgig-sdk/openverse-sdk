# Openverse SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenverseSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenverseSDK(...) and OpenverseSDK.test(...) become
#      OpenverseSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "openverse_sdk"
_SDK_CLASS = "OpenverseSDK"
...
_ENTITIES = {
    "Audio": "audio",
    "Image": "image",
    "OAuth2Application": "o_auth2_application",
    "OAuth2KeyInfo": "o_auth2_key_info",
