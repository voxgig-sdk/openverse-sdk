...
func registerSDKWords(r *eng.Registry, client *sdk.OpenverseSDK) {
...
func runOp(client *sdk.OpenverseSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
