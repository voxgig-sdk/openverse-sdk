...
class OpenverseSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = OpenverseHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = OpenverseHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!OpenverseFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, OpenverseFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return OpenverseUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = OpenverseHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = OpenverseHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = OpenverseHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new OpenverseError($op . "_allow",
                "OpenverseSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = OpenverseHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new OpenverseError("graphql_error",
                "OpenverseSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Audio($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_audio === null) {
                $this->_audio = new AudioEntity($this, null);
            }
            return $this->_audio;
        }
        return new AudioEntity($this, $data);
    }
    ...
    public function OAuth2Application($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_o_auth2_application === null) {
                $this->_o_auth2_application = new OAuth2ApplicationEntity($this, null);
            }
            return $this->_o_auth2_application;
        }
        return new OAuth2ApplicationEntity($this, $data);
    }
    ...
    public function OAuth2KeyInfo($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_o_auth2_key_info === null) {
                $this->_o_auth2_key_info = new OAuth2KeyInfoEntity($this, null);
            }
            return $this->_o_auth2_key_info;
        }
        return new OAuth2KeyInfoEntity($this, $data);
    }
    ...
    public function OAuth2Token($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_o_auth2_token === null) {
                $this->_o_auth2_token = new OAuth2TokenEntity($this, null);
            }
            return $this->_o_auth2_token;
        }
        return new OAuth2TokenEntity($this, $data);
    }
