...
class OAuth2ApplicationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "o_auth2_application";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OAuth2ApplicationEntity($this->_client, $opts);
    }

    /**
     * @param OAuth2Application|array $args OAuth2Application data (assoc-array) to store.
     */
    ...
    /**
     * @return OAuth2Application|array The current OAuth2Application data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OAuth2Application fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OAuth2Application fields).
     */
    ...
    /**
     * Create a new OAuth2Application.
     *
     * @param OAuth2ApplicationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OAuth2ApplicationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OAuth2Application|array The created OAuth2Application as an assoc-array at the
