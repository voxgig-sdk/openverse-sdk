...
class OAuth2TokenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OAuth2TokenEntity($this->_client, $opts);
    }

    /**
     * @param OAuth2Token|array $args OAuth2Token data (assoc-array) to store.
     */
    ...
    /**
     * @return OAuth2Token|array The current OAuth2Token data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OAuth2Token fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OAuth2Token fields).
     */
     ...
     *
     * @param OAuth2TokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OAuth2TokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OAuth2Token|array The created OAuth2Token as an assoc-array at the
