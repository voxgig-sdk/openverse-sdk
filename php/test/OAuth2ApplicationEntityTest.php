...
class OAuth2ApplicationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set OPENVERSE_TEST_O_AUTH2_APPLICATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $o_auth2_application_ref01_data = Helpers::to_map(is_object($o_auth2_application_ref01_data_result) && method_exists($o_auth2_application_ref01_data_result, 'data_get') ? $o_auth2_application_ref01_data_result->data_get() : $o_auth2_application_ref01_data_result);
...
function o_auth2_application_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("OPENVERSE_TEST_O_AUTH2_APPLICATION_ENTID");
