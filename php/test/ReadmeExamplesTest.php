...
// Openverse SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenverseSDK::test)
...
{
    private const SDK_CLASS = 'OpenverseSDK';
    ...
    private const SDK_BASE = 'openverse_sdk';
