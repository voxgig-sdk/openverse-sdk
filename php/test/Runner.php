...
class OpenverseTestRunner
{
    ...
    {
        $live = self::getenv('OPENVERSE_TEST_LIVE');
        $override = self::getenv('OPENVERSE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('OPENVERSE_TEST_EXPLAIN');
...
class_alias('OpenverseTestRunner', 'Runner');
class_alias('OpenverseHelpers', 'Helpers');
