...
// Openverse SDK clienttrack feature
...
class OpenverseClienttrackFeature extends OpenverseBaseFeature
{
    ...
    public function PostConstruct(OpenverseContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Openverse-SDK';
