...
class OpenverseProxyFeature extends OpenverseBaseFeature
{
    ...
    public function init(OpenverseContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenverseContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
