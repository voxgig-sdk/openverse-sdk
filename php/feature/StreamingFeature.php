...
// Openverse SDK streaming feature
...
class OpenverseStreamingFeature extends OpenverseBaseFeature
{
    ...
    private function _iterate(OpenverseResult $result): \Generator
    {
    ...
    private function _streamable(OpenverseContext $ctx): bool
    {
