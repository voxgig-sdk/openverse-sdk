...
class OpenverseCacheFeature extends OpenverseBaseFeature
{
    ...
    private function _through(OpenverseContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
