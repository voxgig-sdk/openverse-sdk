...
class OpenverseFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenverseSDK/1.0)';
    ...
    public static function call(OpenverseContext $ctx, string $fullurl, array $fetchdef): array
    {
