...
const testSeed = `map[string]any{"entity": map[string]any{"audio": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "image": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "o_auth2_application": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "o_auth2_key_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "o_auth2_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
