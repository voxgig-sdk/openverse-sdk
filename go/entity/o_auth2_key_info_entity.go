...
type OAuth2KeyInfoEntity struct {
	name    string
...
func NewOAuth2KeyInfoEntity(client *core.OpenverseSDK, entopts map[string]any) *OAuth2KeyInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OAuth2KeyInfoEntity) GetName() string { return e.name }
...
func (e *OAuth2KeyInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OAuth2KeyInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *OAuth2KeyInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOAuth2KeyInfoEntity(e.client, opts)
}

func (e *OAuth2KeyInfoEntity) Data(args ...any) any {
...
func (e *OAuth2KeyInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *OAuth2KeyInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OAuth2KeyInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OAuth2KeyInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OAuth2KeyInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OAuth2KeyInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OAuth2KeyInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
