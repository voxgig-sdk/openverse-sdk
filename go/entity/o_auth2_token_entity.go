...
func (e *OAuth2TokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OAuth2TokenEntity) Deleted() bool {
	return e.deleted
}
...
func (e *OAuth2TokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
