...
func NewAudioEntity(client *core.OpenverseSDK, entopts map[string]any) *AudioEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AudioEntity) GetName() string { return e.name }
...
func (e *AudioEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AudioEntity) Deleted() bool {
	return e.deleted
}


func (e *AudioEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAudioEntity(e.client, opts)
}

func (e *AudioEntity) Data(args ...any) any {
...
func (e *AudioEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Audio; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AudioEntity) DataTyped(data ...Audio) Audio {
	if len(data) > 0 {
		return typedFrom[Audio](e.Data(asMap(data[0])))
	}
	return typedFrom[Audio](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Audio (all fields
// optional at the wire level).
func (e *AudioEntity) MatchTyped(match ...Audio) Audio {
	if len(match) > 0 {
		return typedFrom[Audio](e.Match(asMap(match[0])))
	}
	return typedFrom[Audio](e.Match())
}
...
func (e *AudioEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AudioEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AudioLoadMatch and returns an Audio. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AudioEntity) LoadTyped(reqmatch AudioLoadMatch, ctrl map[string]any) (Audio, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Audio{}, err
	}
	return typedFrom[Audio](res), nil
}




func (e *AudioEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AudioListMatch and returns []Audio. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AudioEntity) ListTyped(reqmatch AudioListMatch, ctrl map[string]any) ([]Audio, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Audio](res), nil
}




func (e *AudioEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AudioCreateData and returns an Audio. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AudioEntity) CreateTyped(reqdata AudioCreateData, ctrl map[string]any) (Audio, error) {
...
func (e *AudioEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AudioEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AudioEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
