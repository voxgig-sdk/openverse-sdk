...
type OAuth2ApplicationEntity struct {
	name    string
...
func NewOAuth2ApplicationEntity(client *core.OpenverseSDK, entopts map[string]any) *OAuth2ApplicationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OAuth2ApplicationEntity) GetName() string { return e.name }
...
func (e *OAuth2ApplicationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OAuth2ApplicationEntity) Deleted() bool {
	return e.deleted
}


func (e *OAuth2ApplicationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOAuth2ApplicationEntity(e.client, opts)
}

func (e *OAuth2ApplicationEntity) Data(args ...any) any {
...
func (e *OAuth2ApplicationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OAuth2Application; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OAuth2ApplicationEntity) DataTyped(data ...OAuth2Application) OAuth2Application {
	if len(data) > 0 {
		return typedFrom[OAuth2Application](e.Data(asMap(data[0])))
	}
	return typedFrom[OAuth2Application](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OAuth2Application (all fields
// optional at the wire level).
func (e *OAuth2ApplicationEntity) MatchTyped(match ...OAuth2Application) OAuth2Application {
	if len(match) > 0 {
		return typedFrom[OAuth2Application](e.Match(asMap(match[0])))
	}
	return typedFrom[OAuth2Application](e.Match())
}
...
func (e *OAuth2ApplicationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OAuth2ApplicationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OAuth2ApplicationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OAuth2ApplicationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OAuth2ApplicationCreateData and returns an OAuth2Application. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OAuth2ApplicationEntity) CreateTyped(reqdata OAuth2ApplicationCreateData, ctrl map[string]any) (OAuth2Application, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OAuth2Application{}, err
	}
	return typedFrom[OAuth2Application](res), nil
}



func (e *OAuth2ApplicationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OAuth2ApplicationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OAuth2ApplicationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
