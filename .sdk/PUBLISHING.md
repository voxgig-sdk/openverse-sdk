...
|---|---|---|
| `ts/` | @voxgig-sdk/openverse-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/openverse-sdk \
      --repository voxgig-sdk/openverse-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/openverse-sdk` shows it, and
`npm trust revoke @voxgig-sdk/openverse-sdk --id=<id>` removes it.
