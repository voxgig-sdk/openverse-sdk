...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = OpenverseOmni.make_runner(TEST_JSON_FILE, OpenverseSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : OpenverseOmni.errify(err)
    end
