...
class OpenverseGraphql
{
    ...
    // equivalent.
    public static function body(OpenverseContext $ctx): mixed
    {
    ...
    public static function errors(OpenverseContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
