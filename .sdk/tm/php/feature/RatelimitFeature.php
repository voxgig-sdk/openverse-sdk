...
// Openverse SDK ratelimit feature
...
class OpenverseRatelimitFeature extends OpenverseBaseFeature
{
    ...
    private function _acquire(OpenverseContext $ctx): void
    {
    ...
    private function _track(OpenverseContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
