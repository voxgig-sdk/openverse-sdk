...
class OpenverseRbacFeature extends OpenverseBaseFeature
{
    ...
    private function _required(OpenverseContext $ctx): ?string
    {
    ...
    private function _reject(OpenverseContext $ctx, string $required): void
    {
    ...
    private function _track(OpenverseContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
