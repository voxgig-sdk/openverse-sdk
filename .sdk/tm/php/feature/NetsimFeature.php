...
class OpenverseNetsimFeature extends OpenverseBaseFeature
{
    ...
    private function _simulate(OpenverseContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpenverseContext $ctx, array $applied): void
    {
        $client = $this->client;
