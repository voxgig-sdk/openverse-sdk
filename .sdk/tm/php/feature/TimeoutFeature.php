...
class OpenverseTimeoutFeature extends OpenverseBaseFeature
{
    ...
    private function _with_timeout(OpenverseContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenverseContext $_ctx, float $ms): void
    {
        $client = $this->client;
