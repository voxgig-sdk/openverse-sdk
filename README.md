...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/openverse` | `npm install @voxgig-sdk/openverse` |
| Python | `voxgig-sdk-openverse` | `pip install voxgig-sdk-openverse` |
| PHP | `voxgig-sdk/openverse` | `composer require voxgig-sdk/openverse` |
| Golang | `github.com/voxgig-sdk/openverse-sdk/go` | `go get github.com/voxgig-sdk/openverse-sdk/go` |
| Ruby | `voxgig-sdk-openverse` | `gem install voxgig-sdk-openverse` |
| Lua | `voxgig-sdk-openverse` | `luarocks install voxgig-sdk-openverse` |
