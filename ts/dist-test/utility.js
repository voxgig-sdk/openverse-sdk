...
function envOverride(m) {
    if ('TRUE' === process.env.OPENVERSE_TEST_LIVE ||
        'TRUE' === process.env.OPENVERSE_TEST_OVERRIDE) {
    ...
    m.OPENVERSE_TEST_EXPLAIN = process.env.OPENVERSE_TEST_EXPLAIN || m.OPENVERSE_TEST_EXPLAIN;
    return m;
}
