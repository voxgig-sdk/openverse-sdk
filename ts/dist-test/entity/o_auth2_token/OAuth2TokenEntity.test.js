...
(0, node_test_1.describe)('OAuth2TokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != o_auth2_token_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/o_auth2_token/OAuth2TokenTestData.json');
    ...
    let idmap = transform(['o_auth2_token01', 'o_auth2_token02', 'o_auth2_token03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=OAuth2TokenEntity.test.js.map