...
(0, node_test_1.describe)('ImageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(!isempty(select(image_ref01_list, { id: image_ref01_data.id })));
        // LOAD
...
function basicSetup(extra) {
    ...
    let idmap = transform(['image01', 'image02', 'image03', 'image01', 'image02', 'image03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['OPENVERSE_TEST_IMAGE_ENTID'];
