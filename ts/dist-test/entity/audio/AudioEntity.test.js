...
(0, node_test_1.describe)('AudioEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.Audio();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.OPENVERSE_TEST_LIVE;
        for (const op of ['create', 'list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'audio.' + op, live))
                return;
        }
        ...
        // CREATE
        const audio_ref01_ent = client.Audio();
        ...
        (0, node_assert_1.default)(null != audio_ref01_data.id);
        // LIST
        const audio_ref01_match = {};
        const audio_ref01_list = (await audio_ref01_ent.list(audio_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(audio_ref01_list, { id: audio_ref01_data.id })));
        // LOAD
        const audio_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(audio_ref01_data_dt0.id === audio_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/audio/AudioTestData.json');
    ...
    let idmap = transform(['audio01', 'audio02', 'audio03', 'audio01', 'audio02', 'audio03', 'image01', 'image02', 'image03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['OPENVERSE_TEST_AUDIO_ENTID'];
...
//# sourceMappingURL=AudioEntity.test.js.map