...
(0, node_test_1.describe)('OAuth2KeyInfoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-o_auth2_key_info', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-o_auth2_key_info', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENVERSE_TEST_O_AUTH2_KEY_INFO_ENTID'];
...
//# sourceMappingURL=OAuth2KeyInfoDirect.test.js.map