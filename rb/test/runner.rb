...
module OpenverseTestRunner
  ...
  def self.env_override(m)
    live = getenv("OPENVERSE_TEST_LIVE")
    override = getenv("OPENVERSE_TEST_OVERRIDE")
    ...
    explain = getenv("OPENVERSE_TEST_EXPLAIN")
    m["OPENVERSE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = OpenverseTestRunner
Helpers = OpenverseHelpers
Vs = VoxgigStruct
