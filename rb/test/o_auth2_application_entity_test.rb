...
class OAuth2ApplicationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set OPENVERSE_TEST_O_AUTH__APPLICATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def o_auth2_application_basic_setup(extra)
  ...
  entid_env_raw = ENV["OPENVERSE_TEST_O_AUTH__APPLICATION_ENTID"]
